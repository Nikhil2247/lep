-- ============================================================
-- LEP Version 2 – Production Database (Fresh Install)
-- Consolidated final schema + Cycle 1 master data
-- Engine: MySQL 8.0+ / MariaDB 10.6+
-- Charset: utf8mb4
-- ============================================================
--
-- Installation (recommended):
--   1. Create database and user in MySQL (or use the CREATE below)
--   2. mysql -u USER -p < LEP_V2_Production.sql
--
-- This script is for a FRESH install only. It drops existing LEP tables
-- in the selected database if they already exist.
-- ============================================================
...
-- Drop in dependency order (fresh install)
...
-- ============================================================
-- MASTER DATA (final Cycle 1 state)
-- Districts/Blocks/Schools: import via master_import.php from official Excel
-- ============================================================

INSERT INTO cycles (name, sort_order, is_active) VALUES
('Cycle 1', 1, 1);

INSERT INTO grades (name, is_school_leader, sort_order, is_active) VALUES
('Pre-Primary (A-B)', 0, 1, 1),
('Grade 1',           0, 2, 1),
('Grade 2',           0, 3, 1),
('Grade 3',           0, 4, 1),
('Grade 4',           0, 5, 1),
...
('Grade 7',           0, 8, 1),
('Grade 8',           0, 9, 1),
('School Leaders',    1, 99, 1);

INSERT INTO subjects (name, sort_order, is_active) VALUES
('Pre-Primary Teacher (Grade A & B)', 1, 1),
('Arts Teacher (A & B)',              2, 1),
('Literacy Teacher (Grade 1, 2 & 3)', 3, 1),
('Numeracy Teacher (Grade 1, 2 & 3)', 4, 1),
('Arts Teacher (Grade 1-5)',          5, 1),
('Arts Teacher (Grade 6-8)',         10, 1),
('Math (Grade 4)',                   20, 1),
('English (Grade 4)',                21, 1),
('Math (Grade 5)',                   22, 1),
('English (Grade 5)',                23, 1),
('Math (Grade 6)',                   24, 1),
('Science (Grade 6)',                25, 1),
('Math (Grade 7)',                   26, 1),
('Science (Grade 7)',                27, 1),
('Math (Grade 8)',                   28, 1),
('Science (Grade 8)',                29, 1);

-- Grade ↔ Subject map (School Leaders has no subject rows)
...
-- Cycle 1 projects & tasks (from final v1.6 master)
...
-- Official project document filenames (v1.6.1)
-- ============================================================
...
-- ============================================================
-- End of LEP Version 2 production schema + seed
-- Next steps after import:
--   1. Configure config/config.php with VPS DB credentials
--   2. Run master_import.php to load official school master data
--   3. Place official project PDFs in uploads/projects/ (exact filenames)
-- ============================================================
